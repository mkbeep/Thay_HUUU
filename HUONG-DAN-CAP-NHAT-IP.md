...
API_URL=http://192.168.1.3:3000/api/v1
CUSTOMER_WEB_BASE_URL=http://192.168.1.3:8081
```

**admin-web/.env:**
```env
VITE_API_URL=http://192.168.1.3:3000/api/v1
VITE_CUSTOMER_WEB_URL=http://192.168.1.3:8081
```

**backend/.env:**
```env
BACKEND_URL=http://192.168.1.3:3000
CORS_ORIGIN=http://localhost:5173,http://192.168.1.3:5173,http://localhost:8081,http://192.168.1.3:8081,http://localhost:19006,http://192.168.1.3:19006
CUSTOMER_WEB_BASE_URL=http://192.168.1.3:8081
```
...
```
http://192.168.1.3:8081/table/{số_bàn}?tid={id_bàn}
```

Ví dụ:
- Bàn 1: `http://192.168.1.3:8081/table/1?tid=table1`
- Bàn G01: `http://192.168.1.3:8081/table/G01?tid=tableG01`
...
Mở trình duyệt: `http://192.168.1.3:5173`

### 3. Kiểm tra Customer Web:
Mở trình duyệt: `http://192.168.1.3:8081`
...
2. Kiểm tra kết nối: `ping 192.168.1.3`
3. Kiểm tra backend: `curl http://192.168.1.3:3000/api/v1/health`
