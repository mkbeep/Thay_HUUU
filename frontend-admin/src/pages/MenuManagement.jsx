...
const MenuManagement = () => {
  const [menuItems] = useState([
    { id: 1, name: 'Phở bò', category: 'Món chính', price: 50000, status: 'Còn hàng' },
    { id: 2, name: 'Bún chả', category: 'Món chính', price: 45000, status: 'Còn hàng' },
    { id: 3, name: 'Cơm tấm', category: 'Món chính', price: 40000, status: 'Hết hàng' },
    { id: 4, name: 'Trà đá', category: 'Đồ uống', price: 5000, status: 'Còn hàng' },
  ]);
    ...
    <div className="space-y-6">
      ...
      <div className="sm:flex sm:items-center sm:justify-between">
        <div>
          ...
          <p className="mt-1 text-sm text-gray-500">Danh sách món ăn và đồ uống</p>
        </div>
